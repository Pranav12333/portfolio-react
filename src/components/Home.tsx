    ...
    >
      ...
      <div className="hero-content relative z-10 max-w-7xl w-full">
          ...
          <div className="flex flex-col items-center lg:items-start lg:flex-1 order-2 lg:order-1">
            ...
            <div className="max-w-2xl mb-8">
              <p className="text-gray-400 text-base sm:text-lg leading-relaxed mb-6">
                🚀 <span className="text-indigo-300 font-semibold">Transforming ideas into stunning digital experiences</span> with modern web technologies and creative design thinking.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/10 backdrop-blur-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">Figma, Tailwind</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <p className="text-gray-400 text-base sm:text-lg">
                💡 Ready to bring your vision to life with <span className="text-purple-300 font-semibold">pixel-perfect designs</span>, <span className="text-indigo-300 font-semibold">seamless user experiences</span>, and <span className="text-pink-300 font-semibold">robust functionality</span>.
              </p>
            </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-sm sm:text-base mb-4">💼 Available for freelance projects and full-time opportunities</p>
